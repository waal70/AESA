...
public class Util {
	...
	private static final byte[][] P =  {
	    {  // p0
	        ...
	        (byte) 0x18, (byte) 0xF7, (byte) 0xFC, (byte) 0x6C, //FC was EC
	...
	public static void main(String[] args) {
		...
		log.debug ("main klaar");
		
		
		//The byte array version:
		//InputStream is = new ByteArrayInputStream(P[0]);
		//The file version:
	...
	public static int calculateIterations(int inputSize)
	{
		...
		return (int) Math.ceil((double) inputSize / AESAConstants.DEFAULT_BLOCK_SIZE);
